        ...
        'fullscreen=yes' // only works in IE, but here for completeness
            ...
            if (navigator.userAgent.toLowerCase().indexOf('chrome') > -1) {
                ...
                popupWin.document.write('<!DOCTYPE html><html><head> <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"> <meta name="format-detection" content="telephone=no">' +
                    ...
                    '<link href="/content/styles.css" rel="stylesheet"> <link href="/Content/StyleSheet.min.css" rel="stylesheet"> <link href="/Content/print.css?ver=0.3" rel="stylesheet"> <link href="/Content/printWorker.css?ver=4" rel="stylesheet"> ' +
